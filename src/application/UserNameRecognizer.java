...
public class UserNameRecognizer {
	 ...
	 * @version 1.02        2025-01-18  Adding functionality for user name starting with A-Z or a-z
	 * 									but NOT 0-9. Updated error messages for said functionality
	 * 									as well. Also added underscore and minus sign to special character
	 *									list with period. Error message for special chars also updated
	 */
	...
	public static String checkForValidUserName(String input) {
		...
		case 0:
			...
			// Updating error message to present correct info for starting symbols
		...
		case 2:
			...
			// Updated error message to contain info for underscore and minus sign as well
			userNameRecognizerErrorMessage +=
