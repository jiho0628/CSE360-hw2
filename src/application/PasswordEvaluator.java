...
public class PasswordEvaluator {
	 ...
	 * @version 0.01        2025-01-22  Updated special characters to remove
	 * 									characters not found in given FSM diagram
	 * 
	 */
	...
	public static String evaluatePassword(String input) {
		...
		while (running) {
			...
			} else if ("~`!@#$%^&*()_-+{}[]|:;,.?/".indexOf(currentChar) >= 0) { // removed special characters not included in FSM
