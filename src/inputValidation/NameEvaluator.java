    ...
    public static String checkForValidName(String input) {
        ...
        while (running) {
            switch (state) {
                ...
                case 1: 
                    if (Character.isLetter(currentChar)) { // Alphanumeric characters
                        nextState = 1;
                        userNameSize++;
                     // . -> State 2
		...
		case 0:
			...
			userNameRecognizerErrorMessage += "A Name must start with A-Z, a-z.\n";
		...
		case 1:
			...
			if (userNameSize < 2) {
				...
				userNameRecognizerErrorMessage += "A Name must have at least 2 characters.\n";
				return userNameRecognizerErrorMessage;
			}
			else if (userNameSize > 32) {
				// UserName is too long
				userNameRecognizerErrorMessage += 
					"A Name must have no more than 32 character.\n";
				return userNameRecognizerErrorMessage;
			}
//			else if (currentCharNdx < input.length()) {
//				// There are characters remaining in the input, so the input is not valid
//				userNameRecognizerErrorMessage += 
//					"The Name contains invalid characters. (allowed characters: _ , - , . )\n";
//				return userNameRecognizerErrorMessage;
//			}
			else {
					// UserName is valid
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A Name character contains not allowed characters ('.',  '-',  '_')>\n";
			return userNameRecognizerErrorMessage;
