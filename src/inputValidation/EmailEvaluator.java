...
public class EmailEvaluator {
    public static String emailEvaluatorErrorMessage = "";	// The error message text
    public static String userNameRecognizerInput = "";			// The input being processed
    public static int emailEvaluatorIndexofError = -1;		// The index of error location
    ...
    public static String checkForValidEmail(String input) {
        if (input.length() <= 0) {
            emailEvaluatorIndexofError = 0;
            emailEvaluatorErrorMessage = "\nERROR: The input is empty";
            return emailEvaluatorErrorMessage; //clean up the asterisks
        }
        else if  (!isValidEmail(input)) {
            	return "ERROR: Invalid input";
            }
        else {
        	emailEvaluatorIndexofError = -1;
        	emailEvaluatorErrorMessage = "";
			return emailEvaluatorErrorMessage;
        }
    }
}
...
//public class EmailEvaluator {
//    /**
//     * 64 characters @ 253 characters (.com .edu .gov)
